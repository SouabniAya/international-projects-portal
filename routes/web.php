...
// ---- Login (your existing GET /login closure route can stay as-is) ----
...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    Route::get('/requests-documents', [RequestsDocumentsController::class, 'index'])->name('admin.requests-documents');
    Route::post('/partnership-requests/{requestID}/approve', [RequestsDocumentsController::class, 'approvePartnership'])->name('admin.partnership.approve');
    Route::post('/partnership-requests/{requestID}/reject', [RequestsDocumentsController::class, 'rejectPartnership'])->name('admin.partnership.reject');
    Route::post('/documents/{documentID}/approve', [RequestsDocumentsController::class, 'approveDocument'])->name('admin.document.approve');
Route::post('/documents/{documentID}/reject', [RequestsDocumentsController::class, 'rejectDocument'])->name('admin.document.reject');
Route::delete('/documents/{documentID}', [\App\Http\Controllers\Admin\DocumentController::class, 'destroy'])->name('admin.documents.destroy');
});
