...
<div class="mob-page">
   ...
   <a href="{{ route('admin.opportunities') }}" class="mob-page__back">
    ...
    <div class="mob-page__head">
        <div>
            ...
            <div class="mob-page__badges">
                <span class="mob-badge mob-badge--{{ strtolower($mobility['direction']) }}">
                    {{ __($mobility['direction']) }}
                </span>

                <span class="mob-badge mob-badge--{{ strtolower($mobility['status']) }}">
                    {{ __($mobility['status']) }}
                </span>
            </div>
        </div>
        ...
        <div class="mob-page__actions">
            ...
            <a href="{{ $mobility['website'] }}"
               class="mob-page__btn mob-page__btn--primary">
                {{ __('Apply Now') }}
            ...
            <button type="button"
                    class="mob-page__btn mob-page__btn--secondary">
                <svg viewBox="0 0 24 24" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mob-main">
            ...
            <div class="mob-card mob-card--intro">
                ...
                <div class="mob-intro">
                    ...
                    <img src="{{ asset($mobility['institution_logo']) }}"
                         alt="{{ __($mobility['institution']) }}"
                         class="mob-intro__logo">

                    <div>
                        <span class="mob-intro__institution">
                            {{ __($mobility['institution']) }}
                        </span>

                        <h2>{{ __($mobility['title']) }}</h2>

                        <p class="mob-intro__subtitle">
                    ...
                    <div class="mob-keyinfo">
                        ...
                        <ul class="mob-keyinfo__col">
                            @foreach ($keyInfoLeft as $item)
                                <li>
                                    <span class="mob-keyinfo__label">
                                        {{ __($item['label']) }}
                                    </span>

                                    <span class="mob-keyinfo__value">
                                        {{ __($item['value']) }}
                                    </span>
                                </li>
                            @endforeach
                                ...
                                <li>
                                    ...
                                    @if(!empty($item['link']))
                                        <a href="mailto:{{ $item['value'] }}"
                                           class="mob-keyinfo__value mob-keyinfo__value--link">
                                            {{ $item['value'] }}
                                        </a>
                                    @else
                                        <span class="mob-keyinfo__value @if(!empty($item['highlight'])) mob-keyinfo__value--highlight @endif">
                                            {{ __($item['value']) }}
                                        </span>
                                    @endif
                ...
                <div class="mob-section">
                    ...
                    <p>{{ __($mobility['about']) }}</p>

                    <a href="{{ $mobility['website'] }}" class="mob-link">
                        {{ __('Visit institution website') }}
                ...
                <ul class="mob-datelist">
                    ...
                    @foreach ($importantDates as $date)
                        <li>
                            ...
                            <span class="mob-datelist__value @if(!empty($date['highlight'])) mob-datelist__value--highlight @endif">
                                {{ __($date['value']) }}
                            </span>
            ...
            <div class="mob-card">
                ...
                <div class="mob-share">
                    ...
                    <a href="#"
                       ...
                       class="mob-share__btn mob-share__btn--linkedin">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M19 3A2 2 0 0 1 21 5v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14ZM8.34 18.34V10.1H5.67v8.24h2.67ZM7 8.94a1.55 1.55 0 1 0 0-3.1 1.55 1.55 0 0 0 0 3.1ZM18.34 18.34v-4.52c0-2.42-1.29-3.55-3.02-3.55-1.39 0-2.01.77-2.36 1.3v-1.11h-2.67c.04.75 0 8.24 0 8.24h2.67v-4.6c0-.25.02-.5.1-.68.2-.5.68-1.03 1.47-1.03 1.04 0 1.46.79 1.46 1.94v4.37h2.67Z"/>
                        </svg>
                    </a>

                    <a href="#"
                       aria-label="{{ __('Share on Facebook') }}"
                       class="mob-share__btn mob-share__btn--facebook">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <a href="#"
                       ...
                       class="mob-share__btn mob-share__btn--x">
                        <svg viewBox="0 0 24 24" fill="currentColor">
                            <path d="M18.24 3H21l-6.5 7.43L22 21h-6.19l-4.84-6.32L5.4 21H2.62l6.96-7.95L2 3h6.34l4.38 5.78L18.24 3Zm-1.08 16.17h1.53L7.9 4.74H6.26l10.9 14.43Z"/>
                        </svg>
                    </a>

                    <a href="mailto:?subject={{ urlencode(__($mobility['title'])) }}"
                       aria-label="{{ __('Share via Email') }}"
                       class="mob-share__btn mob-share__btn--email">
                        <svg viewBox="0 0 24 24" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <rect x="3" y="5"
                                  width="18" height="14"
