...
<form method="POST" action="{{ $action }}" class="card" enctype="multipart/form-data">
    ...
    <div class="card__body">
        ...
        <div class="form-group">
            ...
            @if($news?->image)
                <div style="display:flex; align-items:center; gap:12px; margin-bottom:10px;">
                    ...
                    <span class="form-hint" style="margin-top:0;">Current image — upload a file below to replace it.</span>
                </div>
            @endif
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label" for="newsPublicationDate">Publication date *</label>
            ...
            <div class="form-group">
                <label class="form-label" for="newsProject">Related project</label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label" for="newsStatus">Publication status</label>
            ...
            <div class="form-group">
                <label class="form-label" for="newsPublishedAt">Published at</label>
        ...
        <div class="form-group">
            <label class="form-label" for="newsScheduledAt">Scheduled at</label>
