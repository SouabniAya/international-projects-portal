...
<div class="dash-header">
    ...
    <div class="dash-header__actions">
        <button type="button" class="btn btn--outline btn--sm" data-toast="Report exported (demo — connect a real export endpoint once the backend exists).">⭳ Export Report</button>
...
<div class="section__header" style="margin:-16px 0 20px;">
    <button type="button" class="btn btn--primary btn--sm" data-modal-open="newPartnershipModal">+ New Partnership</button>
</div>
...
<div class="chart-row">
    <div class="chart-card">
        ...
        <div class="donut-legend">
            <div class="donut-legend__row"><span class="donut-legend__dot" style="background:var(--color-deep-space-blue);"></span> Western Europe <span class="donut-legend__value">33%</span></div>
            <div class="donut-legend__row"><span class="donut-legend__dot" style="background:var(--color-cerulean);"></span> North Africa <span class="donut-legend__value">28%</span></div>
            <div class="donut-legend__row"><span class="donut-legend__dot" style="background:var(--color-fresh-sky);"></span> North America <span class="donut-legend__value">21%</span></div>
            <div class="donut-legend__row"><span class="donut-legend__dot" style="background:var(--color-neutral-300);"></span> Other <span class="donut-legend__value">18%</span></div>
        </div>
    </div>
...
<div class="list-row">
    <div class="list-card">
        <div class="list-card__header"><h3>Recent Activity</h3><a href="#">View All</a></div>
        @foreach ([
    ...
    <div class="list-card">
        <div class="list-card__header"><h3>Pending Actions</h3><span class="badge badge--pending">3 awaiting review</span></div>
        @foreach ([
        ...
        <div class="pending-item">
            ...
            <button type="button" class="btn btn--outline btn--sm" data-toast="Reviewing &quot;{{ $item['title'] }}&quot; (demo — link this to the real review flow).">Review</button>
        </div>
        @endforeach
    </div>
</div>
...
<dialog id="newPartnershipModal" class="modal">
    <form method="POST" action="{{ route('admin.partnerships.store') }}" data-demo-submit="Partnership request created (demo — connect this route to persist).">
        @csrf
        ...
        <div class="modal__body">
            <div class="form-group">
                <label class="form-label" for="partnerName">Institution name</label>
                <input class="form-control" type="text" id="partnerName" name="partner_name" required>
            </div>
            <div class="form-row">
                <div class="form-group">
                    <label class="form-label" for="partnerCountry">Country</label>
                    <input class="form-control" type="text" id="partnerCountry" name="country">
                </div>
                <div class="form-group">
                    <label class="form-label" for="partnerType">Institution type</label>
        ...
        <div class="modal__footer">
            ...
            <button type="submit" class="btn btn--primary btn--sm">Create Partnership</button>
        </div>
    </form>
</dialog>
@endsection
