...
@section('title', 'Edit School Presentation')
@php($active = 'cooperation')

@section('content')
<div class="section__header" style="margin-bottom:20px;">
    <h2 style="margin:0;">Edit School Presentation</h2>
    <p style="margin:6px 0 0;">Update the public presentation and office information.</p>
</div>
...
<form method="POST" action="{{ route('admin.school-presentation.update') }}" class="card">
    ...
    <div class="card__body" style="display:grid; gap:18px;">
        ...
        <div class="form-group">
            <label class="form-label" for="internationalizationStrategy">Internationalization Strategy</label>
        ...
        <div class="form-group">
            <label class="form-label" for="missions">Missions</label>
        ...
        <div class="form-group">
            <label class="form-label" for="teachingResearchDomains">Teaching & Research Domains</label>
        ...
        <div class="form-group">
            <label class="form-label" for="partnershipBenefits">Partnership Benefits</label>
        ...
        <div class="form-group">
            <label class="form-label" for="academicCalendar">Academic Calendar</label>
        ...
        <div class="form-group">
            <label class="form-label" for="registrationProcedure">Registration Procedure</label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label" for="officeEmail">Office Email</label>
        ...
        <div class="form-row">
            <div class="form-group">
                <label class="form-label" for="officeAddress">Office Address</label>
            ...
            <div class="form-group">
                <label class="form-label" for="officeLocation">Office Location</label>
        ...
        <div class="form-group">
            <label class="form-label" for="officeHoursText">Office Hours</label>
        ...
        <div style="display:flex; gap:10px; flex-wrap:wrap;">
            <button type="submit" class="btn btn--primary">Save School Presentation</button>
            <a href="{{ route('admin.school-presentation') }}" class="btn btn--outline">Cancel</a>
        </div>
    </div>
</form>
@endsection
