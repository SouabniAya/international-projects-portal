...
<div class="reqdocs-page">
    ...
    @if (session('success'))
        <div class="alert alert--success"
             style="margin-bottom:16px; padding:12px 16px; border-radius:8px; background:#E6F4EA; color:#1E7E34;">
            {{ session('success') }}
        </div>
    @endif
                ...
                <tbody>
                    ...
                    @forelse ($contactRequests as $r)
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $r['date']->format('d M Y h:i A') }}
                            </td>

                            <td>
                                <span class="reqdocs-table__status reqdocs-table__status--{{ strtolower($r['status']) }}">
                                    {{ ucfirst($r['status']) }}
                                </span>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="reqdocs-table__actions">
                                    ...
                                    <a href="{{ route('admin.requests.contact.show', $r['id']) }}"
                                       aria-label="View">
                ...
                <tbody>
                    ...
                    @forelse ($partnerRequests as $r)
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('images/flags/' . $r['country'] . '.png') }}"
                                     alt=""
                            ...
                            <td>
                                ...
                                <div class="reqdocs-table__actions">
                                    ...
                                    <form method="POST"
                                          action="{{ route('admin.partnership.approve', $r['id']) }}"
                                    ...
                                    <form method="POST"
                                          action="{{ route('admin.partnership.reject', $r['id']) }}"
                                          style="display:inline;">
                                    ...
                                    <a href="{{ route('admin.requests.partnership.show', $r['id']) }}"
                                       aria-label="View">
    ...
    <section class="reqdocs-panel">
        ...
        <div class="reqdocs-panel__head">
            ...
            <h2>{{ __('Event Registrations') }}</h2>

            <a href="{{ route('admin.event-registrations') }}"
               class="reqdocs-panel__view-all">
                {{ __('View All') }}
            </a>
        ...
        <div class="reqdocs-table-wrap">
            ...
            <table class="reqdocs-table">
                ...
                <tbody>
                    ...
                    @forelse ($eventRegistrations as $r)
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{ \Illuminate\Support\Carbon::parse($r['date'])->format('d M Y h:i A') }}
                            ...
                            <td>
                                ...
                                <div class="reqdocs-table__actions">
                                    ...
                                    <form method="POST"
                                          action="{{ route('admin.event-registrations.status', $r['id']) }}"
                                          style="display:inline;">
                                    ...
                                    <a href="{{ route('admin.event-registrations.show', $r['id']) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="reqdocs-table__actions">
                                    ...
                                    <form method="POST"
                                          action="{{ route('admin.document.approve', $doc['id']) }}"
                                          style="display:inline;">
                                    ...
                                    <form method="POST"
                                          action="{{ route('admin.document.reject', $doc['id']) }}"
                                          style="display:inline;">
