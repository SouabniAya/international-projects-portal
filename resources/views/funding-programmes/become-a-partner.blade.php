...
<section class="section" style="max-width:760px;">
    ...
    <form method="POST" action="{{ route('become-a-partner.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select class="form-control" id="country" name="country" required>
                    ...
                    <option value="{{ $c->countryCode }}">{{ $c->translation()?->countryName ?? $c->countryCode }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
