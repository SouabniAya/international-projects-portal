...
<form method="POST" action="{{ route('password.email') }}" data-demo-submit="If an account exists for this email, a reset link has been sent (demo — connect this route to send a real email).">
    @csrf
