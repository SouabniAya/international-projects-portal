...
class EventController extends Controller
{
    ...
    public function register(int $id): View
    {
        ...
        $subjects = ContactSubjectRouting::with('translations')
            ...
            ->map(fn ($subject) => [
                ...
                'label' => optional(
                    $subject->translations->firstWhere('languageCode', $locale)
                )->subjectLabel
                    ?? optional(
                        $subject->translations->firstWhere('languageCode', 'en')
                    )->subjectLabel
                    ?? $subject->subjectCode,
            ]);
    ...
    public function registerStore(Request $request, int $id)
    {
        ...
        EventRegistration::create([
            ...
            // Store the attendee type in subjectCode
    ...
    public function show(int $id): View
    {
        ...
        $event = [
            ...
            'project' => $eventModel->project ? [
                ...
                'title' => $eventModel->project->translation($locale)?->title
                    ?? $eventModel->project->acronym,
